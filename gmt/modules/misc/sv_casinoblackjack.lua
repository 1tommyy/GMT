    ...
    if source then
        ...
        if chairId > 7 then
            if GMT.hasGroup(user_id,"Highroller") then
                ...
                GMT.notify(source, '~r~You need to be a Highroller to sit at this table.')
                return
            end
        end
        if chairId <= 7 then
                    ...
                    MySQL.query("casinochips/get_chips", {user_id = user_id}, function(rows, affected)
                        ...
                        if chips >= betAmount then
                            if chairId < 8 and betAmount > 100000 then
                                GMT.notify(source, 'Maximum bet at this table is £100,000.')
                                return
                            end
                            if chairId > 7 and betAmount < 100000 then
                                GMT.notify(source, 'Minimum bet at this table is £100,000.')
                                return
                            end
                            ...
                            GMT.sendDCLog('blackjack-bet',"GMT Blackjack Logs", "> Player Name: **"..GMT.getPlayerName(user_id).."**\n> Player TempID: **"..source.."**\n> Player PermID: **"..user_id.."**\n> Amount: **"..getMoneyStringFormatted(tostring(betAmount)).."**")
                        else 
                                            ...
                                            if blackjackGameData[gameId][source][2][nextCardCount] == true then --if hit 
                                                ...
                                                if currentHand > 21 then
                                                    ...
                                                    if lostAmount > 10000000 then
                                                        TriggerClientEvent('chatMessage', -1, "^7Diamond Casino |", { 128, 128, 128 }, ""..GMT.getPlayerName(GMT.getUserId(source)).." has LOST "..tostring(getMoneyStringFormatted(lostAmount)).." chips!", "alert")
                                                    end
                                                    ...
                                                    if playerPing then
                                                        if playerPing > 0 then
                                                            ...
                                                            if potentialPushAmount > 10000000 then
                                                                TriggerClientEvent('chatMessage', -1, "^7Diamond Casino |", { 128, 128, 128 }, ""..GMT.getPlayerName(GMT.getUserId(source)).." has WON "..tostring(getMoneyStringFormatted(potentialWinAmount)).." chips!", "goodalert")
                                                            end
                                                        end
                                                    end
                                                ...
                                                elseif currentHand == dealerHand then
                                                    ...
                                                    if playerPing then
                                                        if playerPing > 0 then
                                                            ...
                                                            if potentialPushAmount > 10000000 then
                                                                TriggerClientEvent('chatMessage', -1, "^7Diamond Casino |", { 128, 128, 128 }, ""..GMT.getPlayerName(GMT.getUserId(source)).." has LOST "..tostring(getMoneyStringFormatted(potentialPushAmount)).." chips!", "alert")
                                                            end
                                                        end
                                                    end
                                                end
