...
RegisterNetEvent(
    ...
    function()
        ...
        a.onJob = true
        GMT.notify("~g~Royal Mail Job started, exit the car park on your left and head to your first drop off point.")
        while a.onJob do
...
RegisterNetEvent(
    ...
    function(c, d)
        ...
        local f = GMT.loadModel("prop_drug_package")
...
AddEventHandler(
    ...
    function(h, i)
        if i then
            ...
            GMT.createArea("royalmail", a.startVector, 1.5, 6, j, l, m, {})
        end
    end
)
