...
RMenu.Add(
    "store",
    "mainmenu",
    RageUI.CreateMenu("", "Inventory", GMT.getRageUIMenuWidth(), GMT.getRageUIMenuHeight(), "menus", "store")
)
RMenu.Add(
    "store",
    "info",
...
RMenu.Add(
    "store",
    "redeem",
    RageUI.CreateSubMenu(RMenu:Get("store", "info"), "", "Redeem", GMT.getRageUIMenuWidth(), GMT.getRageUIMenuHeight())
)
RMenu.Add(
    "store",
    "vehicleList",
    RageUI.CreateSubMenu(
        ...
        "Vehicles",
        GMT.getRageUIMenuWidth(),
        GMT.getRageUIMenuHeight(), "menus", "gmt_minigames_choosevehicle"))
RMenu.Add(
    "store",
    "vehicleListInner",
    RageUI.CreateSubMenu(
...
local function a2(K)
    l = true
    TriggerServerEvent("GMT:setInVehicleTestingBucket", true)
    z = GMT.getPlayerCoords()
    w = 1
    ...
    m = GMT.spawnVehicle(K, a4.x, a4.y, a4.z, a5, true, false, false)
    n = GetGameTimer()
end
                ...
                function()
                    ...
                    if U.manuallyRedeemable then
                        RageUI.ButtonWithStyle(
                            ...
                            function(X, Y, Z)
                                if Z then
                                    TriggerServerEvent("GMT:getStoreLockedVehicleCategories")
                                end
                            end,
                            RMenu:Get("store", "redeem")
                        )
                        ...
                        RageUI.ButtonWithStyle(
                            ...
                            function(X, Y, Z)
                                if Z then
                                    tGMT.OpenUrl("https://discord.gg/teWebRv3A4")
                                end
                            end
                        )
                    end
                            ...
                            function(X, Y, Z)
                                if Z then
                                    if isInGreenzone then
                                        TriggerServerEvent("GMT:startSellStoreItem", d)
                                    else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if T(U) then
                                    TriggerServerEvent("GMT:redeemStoreItem", d, e)
                                else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if
                                    GMT.canAnim() and GMT.getPlayerCombatTimer() == 0 and GMT.getPlayerVehicle() == 0 and
                                        not GMT.isPlayerInRedZone() and
                                        GMT.getPlayerBucket() == 0
                                 then
...
RMenu.Add(
    "vehicletesting",
    "mainmenu",
    RageUI.CreateMenu("", "Main Menu", GMT.getRageUIMenuWidth(), GMT.getRageUIMenuHeight(), "menus", "store")
)
RMenu.Add(
    "vehicletesting",
    "extras",
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                ...
                                TriggerServerEvent("GMT:setInVehicleTestingBucket", false)
...
local function az()
    if l then
        ...
        local vehicle, aA = GMT.getPlayerVehicle()
...
function GMT.isInStoreTesting()
    return l
end
RegisterNetEvent(
    "GMT:storeDrawEffects",
    function()
        GMT.loadPtfx("scr_xs_celebration")
        GMT.loadPtfx("scr_rcpaparazzo1")
        for I = 1, 4 do
...
RegisterNetEvent(
    "GMT:setStoreLockedVehicleCategories",
    function(aB)
        c = aB
    end
)
RegisterNetEvent("GMT:OpenStoreMenu")
AddEventHandler(
    "GMT:OpenStoreMenu",
    function()
...
RegisterCommand(
    "store",
    function()
        TriggerServerEvent("GMT:OpenStore")
    end
)
RegisterNetEvent(
    "GMT:setStoreRankName",
    function(aC)
        i = aC
    end
)
