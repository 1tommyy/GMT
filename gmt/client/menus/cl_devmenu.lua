RMenu.Add(
    "devmenu",
    "main",
    RageUI.CreateMenu("", "~s~D~w~eveloper Tools", GMT.getRageUIMenuWidth(), GMT.getRageUIMenuHeight(),"menus","devtools"))
RMenu.Add(
    "devmenu",
    "animations",
...
RageUI.CreateWhile(
    ...
    function()
            ...
            RageUI.DrawContent(
                ...
                function()
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                tGMT.clientPrompt(
                                    "Customization [JSON]",
                                    json.encode(tGMT.getCustomization()),
                                    function()
                                    end
                                )
                            end
                        ...
                        function(A, B, C)
                            if C then
                                tGMT.clientPrompt(
                                    ...
                                    "",
                                    function(D)
                                        tGMT.setCustomization(json.decode(D))
                                    end
                                )
                            end
                        end
                        ...
                        function(A, B, C)
                            if C then
                                ...
                                tGMT.clientPrompt(
                                    ...
                                    "",
                                    function(G)
                                        local H = GMT.loadModel(tonumber(G))
                                        if H then
                                            local I =
                                                GetEntityCoords(PlayerPedId()) +
                                                GetEntityForwardVector(PlayerPedId()) * 2.0
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                TriggerEvent("GMT:toggleTrafficMenu")
                            end
                        end
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                local J = GMT.loadModel("a_f_m_beach_01")
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                local J = GMT.loadModel("s_m_m_pilot_02")
                                local K = GMT.getPlayerCoords()
                                CreatePed(1, J, K.x, K.y, K.z, 0.0, true, true)
                                SetModelAsNoLongerNeeded(J)
                            end
                    ...
                    --     function(A, B, C)
                    --         if C then
                    --             local model = GMT.loadModel("s_m_y_swat_01")
                    --             local coords = GMT.getPlayerCoords()
                    --             local ped = CreatePed(1, model, coords.x, coords.y, coords.z, 0.0, true, true)
                    --             SetModelAsNoLongerNeeded(model)
                    --             GiveWeaponToPed(ped, GetHashKey("WEAPON_CARBINERIFLE"), 500, false, true)
                    --             TaskCombatPed(ped, playerPed, 16, 16)
                    --         end
                    --     end
                    -- )
                    -- RageUI.Button(
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                ...
                                GMT.notify("~y~Triggered clear all")
                            end
                        end
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                TriggerServerEvent('GMT:CleanVeh')
                                GMT.notify("~y~Triggered clear vehicles")
                            end
                        end
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                TriggerServerEvent('GMT:CleanObj')
                                GMT.notify("~y~Triggered clear objects")
                            end
                        end
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                TriggerServerEvent('GMT:CleanPed')
                                ...
                                tGMT.clientPrompt(
                                    ...
                                    function(P)
                                        if P and P ~= "" then
                                            ...
                                            tGMT.giveWeapons({[P] = {ammo = 250}}, false,decorpasskey)
                                            GMT.notify("~o~Spawned weapon:\n ~b~" .. P .. "")
                                            TriggerServerEvent("GMT:logWeaponSpawn", 'weapon-logs', "GMT Weapon Logs", P)
                                        end
                                    end
                                )
                            end
        ...
        --                                     if C then
        --                                         u(R)
        --                                         TaskPlayAnim(GMT.getPlayerPed(), R, S[c], 1.0, -1, -1, 1, 0, 0, 0, 0)
        --                                         RemoveAnimDict(R)
        --                                     end
        --                                 end
        --                             )
        ...
        --                         if C then
        --                             u(U.dict)
        --                             TaskPlayAnim(GMT.getPlayerPed(), U.dict, U.anims[c], 1.0, -1, -1, 1, 0, 0, 0, 0)
        ...
        --                             end
        --                             RequestIpl(S[2])
        --                             SetEntityCoords(GMT.getPlayerPed(), GMT.getPlayerCoords())
        --                             local K = GMT.getPlayerCoords()
        --                             local W = GetInteriorAtCoords(K.x, K.y, K.z)
        --                             GMT.notify("[GMT] Ipl ~g~" .. S[1] .. "(" .. S[2] .. ")" .. " ~s~loaded")
        --                         end
        --                     end
        --                 )
        --             end
            ...
            RageUI.DrawContent(
                ...
                function(U)
                    RageUI.ButtonWithStyle(
                        ...
                        function(A, B, C)
                            if C then
                                tGMT.clientPrompt("Prop Name: ","",function(T)
                                    l = T
                                end)
                            end
                        end
...
RegisterCommand("devmenu",function()
    if GMT.isDev() or GMT.hasGroup(user_id, "Founder") then
        RageUI.Visible(RMenu:Get("devmenu", "main"), true)
    end
end,false)
function tGMT.gridPositionSaver(aa, L, M)
    GMT.notify("pick 1st coord, press Y when done")
    ...
    Wait(250)
    GMT.notify("pick 2nd coord, press Y when done")
    while not IsControlJustPressed(0, 246) do
        Wait(0)
    end
    local ac = GetEntityCoords(PlayerPedId())
    Wait(250)
    GMT.notify("pick 3rd coord, press Y when done")
    while not IsControlJustPressed(0, 246) do
        Wait(0)
    end
    ...
    for c = 0, M - 1, 1 do
        for af = 0, L - 1, 1 do
            ...
            GMT.loadModel("a_m_m_fatlatin_01")
            local aj = GMT.spawnVehicle(aa, ai.x, ai.y, ai.z, heading, false, false, false)
    ...
    function()
        while true do
            ...
            if a then
                ...
                GMT.DrawText(0.32, 0.00, "~r~X: ~s~" .. roundx, 0.4)
                GMT.DrawText(0.38, 0.00, "~r~Y: ~s~" .. roundy, 0.4)
                GMT.DrawText(0.445, 0.00, "~r~Z: ~s~" .. roundz, 0.4)
                heading = GetEntityHeading(ak)
                roundh = tonumber(string.format("%.2f", heading))
                GMT.DrawText(0.50, 0.00, "~r~H:~s~ " .. roundh, 0.4)
                local al, am, an = table.unpack(GetEntityRotation(PlayerPedId(), 1))
                GMT.DrawText(0.38, 0.03, "~r~RX: ~s~" .. tonumber(string.format("%.2f", al)), 0.4)
                GMT.DrawText(0.44, 0.03, "~r~RY: ~s~" .. tonumber(string.format("%.2f", am)), 0.4)
                GMT.DrawText(0.495, 0.03, "~r~RZ: ~s~" .. tonumber(string.format("%.2f", an)), 0.4)
                speed = GetEntitySpeed(PlayerPedId())
                rounds = tonumber(string.format("%.2f", speed))
                GMT.DrawText(0.40, 0.92, "~r~Player Speed: ~s~" .. rounds, 0.4)
                health = GetEntityHealth(PlayerPedId())
                GMT.DrawText(0.40, 0.95, "~r~Player Health: ~s~" .. health, 0.4)
                camRotX = GetGameplayCamRot(2).x
                GMT.DrawText(0.36, 0.88, "~r~CR X: ~s~" .. tonumber(string.format("%.2f", camRotX)), 0.4)
                camRotY = GetGameplayCamRot(2).y
                GMT.DrawText(0.44, 0.88, "~r~CR Y: ~s~" .. tonumber(string.format("%.2f", camRotY)), 0.4)
                camRotZ = GetGameplayCamRot(2).z
                GMT.DrawText(0.51, 0.88, "~r~CR Z: ~s~" .. tonumber(string.format("%.2f", camRotZ)), 0.4)
                ...
                if IsPedInAnyVehicle(PlayerPedId(), 1) then
                    ...
                    GMT.DrawText(0.015, 0.76, "~r~Engine Health: ~s~" .. vehenground, 0.4)
                    GMT.DrawText(0.015, 0.73, "~r~Body Health: ~s~" .. vehbodround, 0.4)
                    GMT.DrawText(
                        0.015,
                        0.70,
                        "~r~Vehicle Fuel: ~s~" ..
...
function tGMT.createDebugObject(Q)
    local aX = GMT.loadModel(Q)
...
local IsBenOn = false
RegisterCommand("Bentheborg", function(source, args, rawCommand)
    if not GMT.isDev() or GMT.hasGroup(user_id, "Founder") then
        return
    end
    IsBenOn = not IsBenOn
    if not IsBenOn then
        GMT.enablePunching(false)
        local NormJson = '{"p5":[-1,0],"13":[0,0,0],"p3":[-1,0],"15":[0,0,100],"11":[136,6,0],"p1":[5,7],"1":[0,0,0],"0":[0,0,0],"3":[33,0,0],"2":[2,0,0],"5":[0,0,0],"4":[24,0,0],"p6":[1,0],"16":[33554432,0,6],"p8":[-1,0],"18":[0,0,0],"p10":[-1,0],"modelhash":1885233650,"12":[0,0,0],"6":[10,0,0],"14":[0,0,255],"8":[146,0,0],"p0":[3,1],"10":[0,0,0],"20":[0,0,1],"17":[100663296,0,0],"p7":[-1,0],"19":[0,0,0],"p9":[-1,0],"p4":[-1,0],"9":[0,0,0],"7":[25,2,0],"p2":[41,0]}'
        tGMT.setCustomization(json.decode(NormJson))
    ...
    GMT.notify("~r~Neigh ger")
    GMT.enablePunching(true)
    local horseJson = '{"p5":[-1,0],"13":[0,0,0],"p3":[-1,0],"15":[0,0,113],"11":[0,0,0],"p1":[-1,0],"1":[0,0,0],"0":[0,0,0],"3":[0,0,0],"2":[0,0,0],"5":[0,0,0],"4":[0,0,0],"p6":[-1,0],"16":[0,0,255],"p8":[-1,0],"18":[0,0,255],"p10":[-1,0],"modelhash":-664053099,"12":[0,0,0],"6":[0,0,0],"14":[0,0,255],"8":[0,0,0],"p0":[-1,0],"10":[0,0,0],"20":[0,0,255],"17":[0,0,255],"p7":[-1,0],"19":[0,0,255],"p9":[-1,0],"p4":[-1,0],"9":[0,0,0],"7":[0,0,0],"p2":[-1,0]}'
    tGMT.setCustomization(json.decode(horseJson))
end)

local propretriever = false
local lastAimedEntity = nil
RegisterCommand("propretriever", function(source, args, rawCommand)
    if not GMT.isDev() or GMT.hasGroup(user_id, "Founder") then return end
    ...
    while true do
        ...
        if propretriever then
            ...
            if IsControlJustPressed(0, 201) and lastAimedEntity then
                ...
                tGMT.CopyToClipBoard(tostring(modelText))
            end
        end
    end
end)
...
RegisterCommand("pftx", function(source, args, rawCommand)
    tGMT.clientPrompt("Enter Particle and dict:","scr_env_agency3b_smoke || core - https://www.vespura.com/fivem/particle-list/",function(K)
        if K and K ~= "" then
            K = stringsplit(K," || ")
            local pfx = K[1]
            local I = K[2] or "core"
