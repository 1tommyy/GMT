...
Citizen.CreateThread(function()
    if true then
        ...
        for d, e in pairs(a) do
            GMT.createArea("identity_" .. d, e, 1.5, 6, h, i, f)
...
--     GMT.notify("~r~You forgot to tie your shoes")
...
RegisterNetEvent("GMT:showIdentity", function(w, x, y, z, A, B, C, D, E)
    ...
    local I = GMT.getFontId("Akrobat-ExtraLight")
    y = string.upper(y)
    z = string.upper(z)
    while p do
