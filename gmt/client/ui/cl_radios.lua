...
RMenu.Add(
    "radios",
    "mainmenu",
    RageUI.CreateMenu("Radios", "~b~M~w~ain Menu", GMT.getRageUIMenuWidth(), GMT.getRageUIMenuHeight())
)
RMenu.Add(
    "radios",
    "advancedeffects",
...
RegisterCommand(
    ...
    function()
        ...
        TriggerEvent("GMT:showRadioWheel", X)
    end,
    false
)
...
RegisterCommand(
    ...
    function()
        if c ~= 0 then
            if exports["pma-voice"]:getRadioVolume() == 0 then
                exports["pma-voice"]:setRadioVolume(u("radios_volume", 10) * 10)
                TriggerServerEvent("GMT:radiosSetIsMuted", false)
            else
                exports["pma-voice"]:setRadioVolume(0)
                TriggerServerEvent("GMT:radiosSetIsMuted", true)
            end
        end
    end,
    false
