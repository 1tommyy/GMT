...
RMenu.Add(
    "stancer",
    "mainmenu",
    RageUI.CreateMenu("", "Stancer", GMT.getRageUIMenuWidth(), GMT.getRageUIMenuHeight(), "menus", "lscustoms")
)
local b = {}
...
local function a0(I, a1)
    ...
    if not H or not H[I] or table.count(H[I]) == 0 then
        ...
        RageUI.ButtonWithStyle(
            ...
            function(a3, a4, a5)
                if a5 then
                    TriggerServerEvent("GMT:stancerBuyMod", E, I)
                end
            end
        )
    else
                ...
                if a0("frontWidth", "Front Track Width") then
                    RageUI.List(
                        ...
                        function(a3, a4, a5, a6)
                            if a6 ~= s then
                                s = a6
                                TriggerServerEvent("GMT:stancerSetModIndex", E, "frontWidth", a6)
                            end
                        end
                    )
                end
                if a0("rearWidth", "Rear Track Width") then
                    RageUI.List(
                        ...
                        function(a3, a4, a5, a6)
                            if a6 ~= v then
                                v = a6
                                TriggerServerEvent("GMT:stancerSetModIndex", E, "rearWidth", a6)
                            end
                        end
                    )
                end
                if a0("frontCamber", "Front Camber") then
                    RageUI.List(
                        ...
                        function(a3, a4, a5, a6)
                            if a6 ~= y then
                                y = a6
                                TriggerServerEvent("GMT:stancerSetModIndex", E, "frontCamber", a6)
                            end
                        end
                    )
                end
                if a0("rearCamber", "Rear Camber") then
                    RageUI.List(
                        ...
                        function(a3, a4, a5, a6)
                            if a6 ~= B then
                                B = a6
                                TriggerServerEvent("GMT:stancerSetModIndex", E, "rearCamber", a6)
                            end
                        end
                    )
                end
...
function setVehicleIdStancer(ac, H)
    ...
    Citizen.CreateThread(
        function()
            ...
            TriggerServerEvent("GMT:stancerSetState", m, e)
        end
    )
end
