globalBlips = {}
function tGMT.addBlip(a, b, c, d, e, f, g, h)
...
function tGMT.addBigBlip(a, b, c, d, e, f, g, h)
    local i = AddBlipForCoord(a + 0.001, b + 0.001, c + 0.001)
    SetBlipSprite(i, d)
...
function tGMT.removeBlip(j)
    RemoveBlip(j)
end
function tGMT.removeBlipAtCoords(x,y,z) -- used to remove green house blips for everyone when purchased
...
local k = {}
function tGMT.setNamedBlip(l, a, b, c, d, e, f, g)
    tGMT.removeNamedBlip(l)
    k[l] = tGMT.addBlip(a, b, c, d, e, f, g)
    return k[l]
end
function tGMT.removeNamedBlip(l)
    if k[l] then
        tGMT.removeBlip(k[l])
        k[l] = nil
    end
end
function tGMT.setGPS(a, b)
    SetNewWaypoint(a + 0.0001, b + 0.0001)
end
function tGMT.setBlipRoute(j)
    SetBlipRoute(j, true)
end
local m = {}
...
local p = {}
local q = {}
function tGMT.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    local I = {
...
function tGMT.setNamedMarker(l, a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    tGMT.removeNamedMarker(l)
    o[l] = tGMT.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    return o[l]
end
function tGMT.removeNamedMarker(l)
    if o[l] then
        tGMT.removeMarker(o[l])
        o[l] = nil
    end
end
local J = {}
...
Citizen.CreateThread(
    function()
        while true do
            q = tGMT.getNearbyMarkers()
            Citizen.Wait(10000)
        end
    end
)
function tGMT.getNearbyMarkers()
    local N = {}
...
function tGMT.setArea(l, a, b, c, T, U)
