...
RP.Shared = {
    ...
    ["carrygmt"] = { -- Male Custom emote by GMT Mods 
        "couplepose1gmt@animation",
        "couplepose1gmt_clip",
        "Carry Me Cute 3",
        "carrygmt2",
        AnimationOptions = {
    ...
    ["carrygmt2"] = { -- Female Custom emote by GMT Mods 
        "couplepose2gmt@animation",
        "couplepose2gmt_clip",
        "Carry Me Cute 4",
        "carrygmt",
        AnimationOptions = {
...
RP.PropEmotes = {
    ...
    ["skatesit"] = { -- Custom Emote By GMT Mods 
        "skateboardposegmtanimation",
        "skateboardposegmt_clip",
        "Skateboard - Sit",
        AnimationOptions = {
