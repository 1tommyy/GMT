...
cfg.weapons = {
    ...
    ["WEAPON_FNTACSHOTGUN"] = {
        name = "Fortnite Tac Shotgun",
        class = "Shotgun",
        ammo = "12 Gauge Bullets",
        policeWeapon = false,
        model = "w_sg_fntacshotgun",
    },
    --? snipers
    ["WEAPON_AX50"] = {
        name = "AX-50",
    ...
    ["WEAPON_BLOODMOSIN"] = {
        ...
        ammo = "7.62mm Bullets",
        policeWeapon = false,
        model = "w_ar_bloodmosin",
    },
    ["WEAPON_GREENMANORMOSIN"] = {
        name = "Green Manor Mosin",
        class = "Shotgun",
        ammo = "7.62mm Bullets",
        policeWeapon = false,
        model = "w_ar_greenmanormosin",
    },
    ["WEAPON_MANORMOSIN"] = {
        name = "Manor Mosin",
        class = "Shotgun",
    ...
    ["WEAPON_NIGHTMOSIN"] = {
        ...
        ammo = "7.62mm Bullets",
        policeWeapon = false,
        model = "w_ar_nightmosin",
    },
    ["WEAPON_PINKMANORMOSINMOSIN"] = {
        name = "Pink Manor Mosin",
        class = "Shotgun",
        ammo = "7.62mm Bullets",
        policeWeapon = false,
        model = "w_ar_pinkmanormosinmosin",
    },
    ["WEAPON_REDLVMOSIN"] = {
        name = "Red LV Mosin",
        class = "Shotgun",
