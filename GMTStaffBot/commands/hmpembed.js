...
exports.runcmd = (fivemexports, client, message, params) => {
    let embed = {
        "title": "GMT His Majesty's Prison Service",
        ...
        "fields": [
            ...
            },
            {
                ...
                "value": "To join the Prison Service, you need to create an account on gmtstudios.net and use the [application](https://soon). Make sure to be in the GMT HMPS Official [Discord](https://discord.gg/JMKm9HQKHg) server.",
            },
            {
