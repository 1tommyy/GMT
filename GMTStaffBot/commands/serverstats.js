...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    let totalBank = 0;
    let totalChips = 0;
    fivemexports.gmt.execute("SELECT * FROM `gmt_user_vehicles`", [], (cars) => {
        fivemexports.gmt.execute("SELECT * FROM `gmt_user_vehicles` WHERE locked = 1", [], (lockedcars) => {
            fivemexports.gmt.execute("SELECT * FROM `gmt_user_data`", [], (userdata) => {
                fivemexports.gmt.execute("SELECT * FROM gmt_warnings", [], (warnings) => {
                    fivemexports.gmt.execute("SELECT * FROM gmt_user_moneys", [], (money) => {
                        fivemexports.gmt.execute("SELECT * FROM gmt_casino_chips", [], (chips) => {
                            fivemexports.gmt.execute("SELECT * FROM `gmt_users`", [], (users) => {
                                fivemexports.gmt.execute("SELECT * FROM gmt_users WHERE banned = 1", (bannedPlayers) => {
                                    fivemexports.gmt.execute("SELECT * FROM gmt_anticheat", (totalACBans) => {
                                        fivemexports.gmt.execute("SELECT MAX(id) as maxId FROM `gmt_users`", [], (totalperms) => {
