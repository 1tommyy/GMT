...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    fivemexports.gmt.execute("SELECT * FROM `gmt_stores` WHERE code = ?", [code], (infoArray) => {
        ...
        fivemexports.gmt.execute("SELECT discord_id FROM `gmt_verification` WHERE user_id = ?", [user_id], (discordIdArray) => {
            ...
            message.channel.send({ embed }).then(sentEmbed => {
                ...
                collector.on('collect', reaction => {
                    ...
                    if (reaction.emoji.name === "✅") {
                        // User confirmed
                        fivemexports.gmt.execute("DELETE FROM gmt_stores WHERE code = ?", [code], (result) => {
